    ...
    return (
        <Center className="team">
            ...
            <Center className="pcard-wrap">
                ...
                <Profilecard name="Priyank Gupta" pos="Membership Chair" pic="https://geu.acm.org/core/Priyank%20Gupta.jpg" />
                <Profilecard name="Abhinav Bhatia" pos="Technical Head" pic="https://geu.acm.org/core/ABHINAV%20MOHAN%20BHATIA.jpg" />
                <Profilecard name="Anshul Pandey" pos="Management Head" pic="https://geu.acm.org/core/Anshul.jpg" />
            </Center>
        </Center>
    )
}